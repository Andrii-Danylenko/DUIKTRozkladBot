...
public class JSONParser {
    ...
    private Iterator<JSONObject> getJsonObject(String serverResponse) throws IOException, ParseException, org.json.simple.parser.ParseException {
    ...
    public Table table(String serverResponse, HashMap<String, String> params) {
        Table table = new Table();
        try {
            table = parseData(getJsonObject(serverResponse),
